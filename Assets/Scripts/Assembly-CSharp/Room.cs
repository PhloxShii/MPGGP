...
public class Room : RoomInfo
{
	...
	public new bool IsOpen
	{
		...
		set
		{
			...
			{
				PhotonNetwork.networkingPeer.OpSetPropertiesOfRoom(new Hashtable { { 253, value } });
			}
			openField = value;
		}
	}
	...
	public new bool IsVisible
	{
		...
		set
		{
			...
			{
				PhotonNetwork.networkingPeer.OpSetPropertiesOfRoom(new Hashtable { { 254, value } });
			}
			visibleField = value;
		}
	}
